...
int main() {
	...
	// Pad message to 16 bytes (zero padding)
	...
	// Edge case: empty message still needs one block
	...
	// Write the encrypted bytes out to file "message.aes" (binary-safe, full length)
	ofstream outfile;
